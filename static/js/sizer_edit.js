                        ...
                        <div class="card-header card-header-active">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-light ml-24" id="saveSizer">修改选型</button>
                                </div>
                            </div>
                        </div>
...
var controller = (function(baseView, baseCtrl, cardCtrl, wkCondCtrl, wkViewCtrl, vldCtrl) {
        ...
        DOM.checkBtn.addEventListener('click', function(event) {
            ...
            promise.then(function (result) {
                ...
                saveBtn.addEventListener("click", function(event) {
                    ...
                    var sizerSaveRequester = baseCtrl.createRequester(URLs.saveSizer, formData);
    ...
    var initTables = function() {
        ...
        wkCondCtrl.initWkConds(tables_num);
    };
